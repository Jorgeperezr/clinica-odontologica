"""
Configuración — modelos definidos en 04-Modelo-de-Datos-Clinica-Odontologica.md.

Implementacion programada para: Sprint 2 (catálogos básicos) y progresivamente en sprints posteriores (ver 07-Roadmap-Clinica-Odontologica.md).
