"""
Tratamientos y pagos — modelos definidos en 04-Modelo-de-Datos-Clinica-Odontologica.md.

Implementacion programada para: Sprints 8-9 (ver 07-Roadmap-Clinica-Odontologica.md).
